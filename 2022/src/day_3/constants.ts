export const LOWERCASE_PRIORITY = 96;
export const UPPERCASE_PRIORITY = 64;
export const DELTA = 26;
...
export const SECOND_PUZZLE_INPUT = `DMwrszrfMzSSCpLpfCCn
...
export const PUZZLE_INPUT = `DMwrszrfMzSSCpLpfCCn
RMvhZhQqlvhMvRtbvbcPclPlncddppLTdppd
tVMQhFtjjWmsFJsmsW
trRtvNhfJhSzzSTFVhQQZQhHGphP
CnLMBWLwDMgMcwwdngdHGPVTQGpTHZdGPGpd
